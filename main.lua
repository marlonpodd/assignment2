...
--answer textfields
local areaOfCircleTextfield = display.newText( "Area is...", display.contentCenterX, display.contentCenterY + 170, native.systemFont, 25 )
areaOfCircleTextfield.id = "area textField"
areaOfCircleTextfield:setFillColor (249/255, 100/255, 77/255)

local circumferenceOfCircleTextfield = display.newText( "Circumference is...", display.contentCenterX, display.contentCenterY + 230, native.systemFont, 25 )
...
local function calculateButtonTouch( event )
    ...
    -- area of circle
    areaOfCircle = diameterOfCircle + 2
    areaOfCircleTextfield.text = "The area is " .. areaOfCircle
    -- circumference of circle
    circumferenceOfCircle = diameterOfCircle + 3
